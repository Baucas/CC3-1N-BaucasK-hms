...
namespace CC3_1N_HMS
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            // Output of DisplayAvailableRooms for hotelYanan
            ...
            // Output of DisplayBookedRooms for hotelYanan
            Console.WriteLine("Booked rooms in Hotel Yanan:");
            hotelYanan.DisplayBookedRooms();
            Console.WriteLine();

            // Output of DisplayReservations for terry
            ...
            // Output of DisplayReservationDetails
